function single_tracking4(testdir)
% only use Haar feature
% ------------------------------------------------
% video file setting
% ------------------------------------------------
...
videoname = tmp{3:4};
fid = fopen(fullfile(testdir, [videoname '_result_Ours[Haar].txt']), 'w');
...
% feature parameters: number of rectangle81 from 2 to 4.
...
[ftr1.px,ftr1.py,ftr1.pw,ftr1.ph,ftr1.pwt] = HaarFtr(clfparams,ftrparams,M);
...
pos_store.feature = getFtrVal(iH, pos_store.sampleImage, ftr1);
neg_store.feature = getFtrVal(iH, neg_store.sampleImage, ftr1);
...
%     clear img;
    ...
    if mod(i,dctparams.freq)==0 || disappear 
        ...
        if sgn == 0
            ...
            disappear = 0;
            detectx.feature = getFtrVal(iH, detectx.sampleImage, ftr1);
    ...
    if c > -60 || i <= 10
        ...
        pos_sample.feature = getFtrVal(iH, pos_sample.sampleImage, ftr1);
